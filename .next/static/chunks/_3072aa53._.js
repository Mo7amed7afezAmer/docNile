...
"[project]/app/(dashboard)/processing/[batch_id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                ...
                "ProcessingPage.useEffect.fetchStatus": async ()=>{
                    try {
                        ...
                        if (data.files) {
                            setFiles(data.files);
                            // Merge all logs
                            const allLogs = data.files.flatMap({
                                "ProcessingPage.useEffect.fetchStatus.allLogs": (f)=>{
                                    var _f_logs;
                                    return (_f_logs = f.logs) === null || _f_logs === void 0 ? void 0 : _f_logs.map({
                                        "ProcessingPage.useEffect.fetchStatus.allLogs": (log)=>"[".concat(f.filename, "] ").concat(log)
                                    }["ProcessingPage.useEffect.fetchStatus.allLogs"]);
                                }
                            }["ProcessingPage.useEffect.fetchStatus.allLogs"]);
                            setLogs(allLogs);
                        }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        fileName: "[project]/app/(dashboard)/processing/[batch_id]/page.tsx",
                        lineNumber: 98,
                        columnNumber: 9
                    }, this),
...
_s(ProcessingPage, "bBiMcxjNBJFHBb36IcMwthWsgE0=", false, function() {
    return [
...
//# sourceMappingURL=_3072aa53._.js.map